...
const Intro = () => {
  return (
    <div data-aos='zoom-in-down'>
        <div className='intro flex text-5xl italic font-shrik font-bold p-3 pt-20 px-5 items-center justify-center'>
...
<div className='flex text-3xl italic font-semibold font-jost p-5 items-center justify-center'>
    ...
    <p>ZenoLayer isn’t just another L2. It’s the degenerate dream:<ol>
      ...
      <li>3. Memes fully chain-ified</li>
      <li>4. Ethereum-compatible (we know you won’t read the docs anyway)</li>
      </ol></p>
    </div>
</div>
  )
